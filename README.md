...
<p>  Here's a quick script you can run to see if there are any open transactions across any of your databases. Sure; there are a number of ways to see this activity, but this might be helpful for something to build on later.
</p> 
